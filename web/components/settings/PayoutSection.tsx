...
export default function PayoutSection() {
  ...
  if (!user?.isDeveloper) {
    return (
      <div className="card p-8">
        <h2 className="heading-serif text-xl text-ink-900 mb-4">Payout Settings</h2>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-8">
        <h2 className="heading-serif text-xl text-ink-900 mb-6">Payout Settings</h2>
        ...
        {!status?.connected ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-ink-900 mb-2">Connect Your Bank Account</h3>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-ink-900 mb-2">Account Connected</h3>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-ink-900 mb-2">Complete Setup</h3>
      ...
      {status?.connected && (
        <div className="card p-8">
          <h3 className="text-lg font-semibold text-ink-900 mb-4">Payout Schedule</h3>
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-ink-900 font-medium">Weekly Payouts</p>
                <p className="text-ink-500 text-sm">Every Monday</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-ink-900 font-medium">Platform Fee</p>
                <p className="text-ink-500 text-sm">10% per sale</p>
              </div>
            </div>
          </div>
        </div>
