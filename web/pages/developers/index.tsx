            ...
            {developers.map((dev, index) => (
              <FadeIn key={dev.id} delay={index * 100}>
                <Link 
                  ...
                  className={`block bg-white border border-slate-200 rounded-2xl p-8 ${dev.borderColor} hover:shadow-xl transition-all h-full relative group`}
                >
                  {/* Verified Badge */}
                  {dev.verified && (
                  ...
                  <p className="text-slate-600 mb-6">{dev.description}</p>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex -space-x-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center border-2 border-slate-900 text-white font-bold text-sm">C</div>
